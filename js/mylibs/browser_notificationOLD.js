...
function browserDetectNotify() {
	...
	// Upgrade path links and solutions:

	// IE 9 or greater and compatibility mode is turned on:
	var ie_compat_link = '<a href="How to turn IE Compatibility Mode Off.html">How to turn IE Compatibility Mode Off</a>';
	var ie_compat_solution = 'Internet Explorer compatibility mode is turned on. This site works so much better with it turned off.<br/><strong>Solution:</strong> ' + ie_compat_link;

	// Either Browser is extremely old (<IE6 time), or Quirks mode is turned on:
	var quirks_link = '<a href="How to turn IE Quirks Mode Off.html">How to turn IE Quirks Mode Off</a>';
	var quirks_solution = 'Either "Quirks Mode" is turned on or you have an extremely old browser. <br/><strong>Solution:</strong> ' + quirks_link;

	// Legacy Browser Versions"
	var legacy_link =   'Please use one of the modern, standards-compliant web browsers below:</a><br/>' +
						'<div id="modern_browsers">' +
							'<a href="http://www.google.com/chrome" title="Install Google Chrome Browser">' + 
								'<img src="images/browser_notification/64-chrome.png" alt="Install Google Chrome Browser" />' + 
								'<br/>Google Chrome' +
							'</a>' + 
							'<a href="http://www.mozilla.org/en-US/firefox/new/" title="Install Mozilla Firefox Browser">' + 
								'<img src="images/browser_notification/64-firefox.png" alt="Install Mozilla Firefox Browser" />' + 
								'<br/>Mozilla Firefox' +
							'</a>' + 
							'<a href="http://www.apple.com/safari/download/" title="Install Apple Safari Browser">' + 
								'<img src="images/browser_notification/64-safari.png" alt="Install Apple Safari Browser" />' + 
								'<br/>Apple Safari' +
							'</a>' + 
						'</div>';
	var legacy_solution = 'This site works much better in a modern browser. <br/><strong>Solution:</strong> ' + legacy_link;
	...
	if ( ($.browser.msie) && ($.browser.version < '9.0') ){
		if(navigator.userAgent.indexOf("Trident/5")>-1) {
			...
			//console.log('ie not legacy browser');
		}
		else {
			message_legacy = 'true';
			message_solution = legacy_solution;
	...
	if ( (message_legacy != '') && (message_solution != '') ) {
		$('#browser_info').html('<p><strong>Issue:</strong> ' + message_solution + '</p>');
